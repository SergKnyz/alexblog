---
title: Opensong I. Первое знакомство
...
- [Систематизация и хранение репертуара:](#system)
 ...
 4. [Практическое применение](#pract)
- [Эпилог](#epi)
...
## 1. Набираем песню в редакторе {#openchords}
...
* Ссылка для установки на мобильные устройства:
  [![ссылка на PlayMarket](/assets/images/opensong6.png)](https://play.google.com/store/apps/details?id=com.garethevans.church.opensongtablet&hl=ru)
...
## 3a. Дублируем базу на облачный сервис {#cloud}
