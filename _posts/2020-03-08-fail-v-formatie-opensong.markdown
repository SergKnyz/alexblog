...
`\Open Chords\..` - главная папка, в нашем случае называется "OpenSongIcf", - рабочий каталог программы с несколькими вложенными файлами и исполнимым файлом программы;
