...
![]({{ site.baseurl }}assets/2015-01-22-design-patterns-cpp/17_builder-min.png)
***Отношения*** 
...
##Контроллер запросов (Front Controller)    {#front_Controller}
![]({{ site.baseurl }}assets/2015-01-22-design-patterns-cpp/front-controller.gif)  
...
##Контроллер приложения (Application Controller)    {#application_controller}
![]({{ site.baseurl }}assets/2015-01-22-design-patterns-cpp/application-controller.gif)  
...
![]({{ site.baseurl }}assets/2015-01-22-design-patterns-cpp/template-view.gif)  
...
##Представление с преобразованием (Transform View)  {#transform_view}
![]({{ site.baseurl }}assets/2015-01-22-design-patterns-cpp/transform-view.gif)  
...
##Двухэтапное представление (Two Step View) {#two_step_view}
![]({{ site.baseurl }}assets/2015-01-22-design-patterns-cpp/two-step-view.gif)  
